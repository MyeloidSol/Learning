...
# Fit Model ----
model <- cmdstanr::cmdstan_model("/Users/todd/Code/Fun/Floating Disks//binomial_model.stan")
...
# Plot Model ----
plot_data <- melt(as.data.table(data), id.vars = "time", variable.name = "beaker", value.name = "floatings")
...
ml_model <- cmdstanr::cmdstan_model("/Users/todd/Code/Fun/Floating Disks//binomial_multilevel_model.stan")
